...
with open('blacklist.txt', 'r') as file_b, \
        open('whitelist.txt', 'r') as file_w, \
        open('newlist.txt', 'w') as file_n:
    newList = file_b.readlines()
    newList.extend(file_w.readlines())
    # print(newList)
    print(*newList, sep='XXXXXXXXXXXXXXXXXXXX\n', end='    Print Finished', file=file_n)
